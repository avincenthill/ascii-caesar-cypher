...
//Array of the frequency in the English language whose indexes are ASCII-table character indexes
...
//Outputs the top five most likely decrypted strings for an encrypted English message
    ...
    if (encryptedString.value.length != 0) {
        for (var i = 0; i < 96; i++) {
            ...
            ratedStrings.push({
                ...
                "rating": howEnglish(rotatedString),
                "shift": 96 - i
            })
        };
    };
...
//jQuery handlers for html buttons and events
